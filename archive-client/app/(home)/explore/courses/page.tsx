      ...
      <section className="py-4 border-b border-border/50 bg-linear-to-b from-background to-muted/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xs text-muted-foreground">
            Expert-led courses for modern developers
          </p>
        </div>
      </section>
                  ...
                  <div className="p-3 rounded-lg border-2 border-border dark:border-input bg-card/50 dark:bg-card/30 backdrop-blur-sm">
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center gap-2 cursor-pointer group p-2 rounded-md hover:bg-accent/50 dark:hover:bg-accent/30 transition-colors">
                        ...
                        />
                        <span className="text-sm font-medium text-foreground group-hover:text-primary dark:group-hover:text-[oklch(0.85_0.28_260)] transition-colors">
                          Trending Courses
                        </span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group p-2 rounded-md hover:bg-accent/50 dark:hover:bg-accent/30 transition-colors">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {levels.map((level) => (
                        <button
                          ...
                          className={`text-center px-3 py-2.5 rounded-lg text-xs font-bold transition-all border-2 ${
                            selectedLevel === level
              ...
              <div className="p-2 rounded-lg border-2 border-border dark:border-input bg-card/50 dark:bg-card/30 backdrop-blur-sm">
                ...
                <div className="space-y-1">
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    ...
                    />
                    <span className="text-[10px] font-medium text-foreground group-hover:text-primary dark:group-hover:text-[oklch(0.85_0.28_260)] transition-colors">
                      Trending
                    </span>
                  </label>
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                ...
                <div className="space-y-1">
                  {levels.map((level) => (
                    <button
                      ...
                      className={`w-full text-left px-2 py-1 rounded-md text-[10px] font-bold transition-all border-2 ${
                        selectedLevel === level
                          ? "bg-primary text-white dark:text-white border-primary shadow-md dark:shadow-[0_0_12px_oklch(0.65_0.18_260/0.3)]"
                          : "bg-card/50 dark:bg-card/30 border-border dark:border-input hover:border-primary/50 dark:hover:border-[oklch(0.75_0.22_260)] hover:bg-accent dark:hover:bg-[oklch(0.28_0.06_260)] text-foreground dark:hover:text-[oklch(0.85_0.28_260)]"
                      }`}
                ...
                >
                  ...
                  <div className="relative aspect-5/2 bg-linear-to-br from-primary/25 via-primary/15 to-primary/5 dark:from-primary/35 dark:via-primary/20 dark:to-primary/5 flex items-center justify-center border-b border-border dark:border-input group-hover:border-primary/40 transition-colors">
                    ...
                    <div className="absolute bottom-1.5 right-1.5 flex items-center gap-1 px-1.5 py-1 rounded bg-card/90 dark:bg-card/80 border border-border/50 dark:border-input/50 shadow-sm backdrop-blur-sm">
                      ...
                      <span className="text-[8px] font-black text-foreground leading-none">
                        {course.rating}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-2.5 sm:p-3 relative">
                    ...
                    {/* Title - More Readable */}
                    <h3
                      className="text-sm sm:text-base font-black text-foreground mb-1.5 
                   group-hover:text-primary transition-all line-clamp-2 
                   leading-tight tracking-tight z-0"
                    >
                      {course.title}
                    </h3>
